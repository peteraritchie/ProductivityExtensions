...
namespace PRI.ProductivityExtensions.GuidConverterExtensions
{

	/// <summary>
	/// Class that contains extension methods that extend <seealso cref="System.ComponentModel.GuidConverter">GuidConverter</seealso>
	/// </summary>
	public static partial class GuidConverterable
	{
		/// <summary>
