...
namespace PRI.ProductivityExtensions.QuestionEventHandlerExtensions
{

	/// <summary>
	/// Class that contains extension methods that extend <seealso cref="System.Windows.Forms.QuestionEventHandler">QuestionEventHandler</seealso>
	/// </summary>
	public static partial class QuestionEventHandlerable
	{
		/// <summary>
