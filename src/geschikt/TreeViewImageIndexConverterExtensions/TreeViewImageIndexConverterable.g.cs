...
namespace PRI.ProductivityExtensions.TreeViewImageIndexConverterExtensions
{

	/// <summary>
	/// Class that contains extension methods that extend <seealso cref="System.Windows.Forms.TreeViewImageIndexConverter">TreeViewImageIndexConverter</seealso>
	/// </summary>
	public static partial class TreeViewImageIndexConverterable
	{
		/// <summary>
