...
namespace PRI.ProductivityExtensions.DataGridViewRowsRemovedEventHandlerExtensions
{

	/// <summary>
	/// Class that contains extension methods that extend <seealso cref="System.Windows.Forms.DataGridViewRowsRemovedEventHandler">DataGridViewRowsRemovedEventHandler</seealso>
	/// </summary>
	public static partial class DataGridViewRowsRemovedEventHandlerable
	{
		/// <summary>
