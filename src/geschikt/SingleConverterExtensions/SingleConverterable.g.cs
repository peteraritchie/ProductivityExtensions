...
namespace PRI.ProductivityExtensions.SingleConverterExtensions
{

	/// <summary>
	/// Class that contains extension methods that extend <seealso cref="System.ComponentModel.SingleConverter">SingleConverter</seealso>
	/// </summary>
	public static partial class SingleConverterable
	{
		/// <summary>
