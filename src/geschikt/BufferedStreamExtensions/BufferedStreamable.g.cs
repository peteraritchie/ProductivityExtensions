...
namespace PRI.ProductivityExtensions.BufferedStreamExtensions
{

	/// <summary>
	/// Class that contains extension methods that extend <seealso cref="System.IO.BufferedStream">BufferedStream</seealso>
	/// </summary>
	public static partial class BufferedStreamable
	{
		/// <summary>
