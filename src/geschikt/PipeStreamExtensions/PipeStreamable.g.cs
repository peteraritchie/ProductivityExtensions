...
namespace PRI.ProductivityExtensions.PipeStreamExtensions
{

	/// <summary>
	/// Class that contains extension methods that extend <seealso cref="System.IO.Pipes.PipeStream">PipeStream</seealso>
	/// </summary>
	public static partial class PipeStreamable
	{
		/// <summary>
