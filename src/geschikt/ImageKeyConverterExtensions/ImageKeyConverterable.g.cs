...
namespace PRI.ProductivityExtensions.ImageKeyConverterExtensions
{

	/// <summary>
	/// Class that contains extension methods that extend <seealso cref="System.Windows.Forms.ImageKeyConverter">ImageKeyConverter</seealso>
	/// </summary>
	public static partial class ImageKeyConverterable
	{
		/// <summary>
