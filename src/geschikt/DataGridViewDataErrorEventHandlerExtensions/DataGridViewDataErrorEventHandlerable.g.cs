...
namespace PRI.ProductivityExtensions.DataGridViewDataErrorEventHandlerExtensions
{

	/// <summary>
	/// Class that contains extension methods that extend <seealso cref="System.Windows.Forms.DataGridViewDataErrorEventHandler">DataGridViewDataErrorEventHandler</seealso>
	/// </summary>
	public static partial class DataGridViewDataErrorEventHandlerable
	{
		/// <summary>
