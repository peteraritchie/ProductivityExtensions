...
namespace PRI.ProductivityExtensions.MemoryMappedViewStreamExtensions
{

	/// <summary>
	/// Class that contains extension methods that extend <seealso cref="System.IO.MemoryMappedFiles.MemoryMappedViewStream">MemoryMappedViewStream</seealso>
	/// </summary>
	public static partial class MemoryMappedViewStreamable
	{
		/// <summary>
