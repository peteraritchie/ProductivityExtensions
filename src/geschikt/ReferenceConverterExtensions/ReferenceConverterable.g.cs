...
namespace PRI.ProductivityExtensions.ReferenceConverterExtensions
{

	/// <summary>
	/// Class that contains extension methods that extend <seealso cref="System.ComponentModel.ReferenceConverter">ReferenceConverter</seealso>
	/// </summary>
	public static partial class ReferenceConverterable
	{
		/// <summary>
