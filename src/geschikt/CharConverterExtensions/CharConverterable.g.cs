...
namespace PRI.ProductivityExtensions.CharConverterExtensions
{

	/// <summary>
	/// Class that contains extension methods that extend <seealso cref="System.ComponentModel.CharConverter">CharConverter</seealso>
	/// </summary>
	public static partial class CharConverterable
	{
		/// <summary>
