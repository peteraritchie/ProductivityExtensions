...
namespace PRI.ProductivityExtensions.TabControlCancelEventHandlerExtensions
{

	/// <summary>
	/// Class that contains extension methods that extend <seealso cref="System.Windows.Forms.TabControlCancelEventHandler">TabControlCancelEventHandler</seealso>
	/// </summary>
	public static partial class TabControlCancelEventHandlerable
	{
		/// <summary>
