...
namespace PRI.ProductivityExtensions.LinkConverterExtensions
{

	/// <summary>
	/// Class that contains extension methods that extend <seealso cref="System.Windows.Forms.LinkConverter">LinkConverter</seealso>
	/// </summary>
	public static partial class LinkConverterable
	{
		/// <summary>
