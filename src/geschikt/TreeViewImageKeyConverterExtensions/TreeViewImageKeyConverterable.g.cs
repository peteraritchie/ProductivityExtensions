...
namespace PRI.ProductivityExtensions.TreeViewImageKeyConverterExtensions
{

	/// <summary>
	/// Class that contains extension methods that extend <seealso cref="System.Windows.Forms.TreeViewImageKeyConverter">TreeViewImageKeyConverter</seealso>
	/// </summary>
	public static partial class TreeViewImageKeyConverterable
	{
		/// <summary>
