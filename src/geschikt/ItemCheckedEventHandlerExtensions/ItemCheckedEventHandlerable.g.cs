...
namespace PRI.ProductivityExtensions.ItemCheckedEventHandlerExtensions
{

	/// <summary>
	/// Class that contains extension methods that extend <seealso cref="System.Windows.Forms.ItemCheckedEventHandler">ItemCheckedEventHandler</seealso>
	/// </summary>
	public static partial class ItemCheckedEventHandlerable
	{
		/// <summary>
