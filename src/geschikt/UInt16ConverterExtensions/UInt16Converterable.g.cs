...
namespace PRI.ProductivityExtensions.UInt16ConverterExtensions
{

	/// <summary>
	/// Class that contains extension methods that extend <seealso cref="System.ComponentModel.UInt16Converter">UInt16Converter</seealso>
	/// </summary>
	public static partial class UInt16Converterable
	{
		/// <summary>
