...
namespace PRI.ProductivityExtensions.UriTypeConverterExtensions
{

	/// <summary>
	/// Class that contains extension methods that extend <seealso cref="System.UriTypeConverter">UriTypeConverter</seealso>
	/// </summary>
	public static partial class UriTypeConverterable
	{
		/// <summary>
