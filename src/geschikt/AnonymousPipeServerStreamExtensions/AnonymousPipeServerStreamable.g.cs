...
namespace PRI.ProductivityExtensions.AnonymousPipeServerStreamExtensions
{

	/// <summary>
	/// Class that contains extension methods that extend <seealso cref="System.IO.Pipes.AnonymousPipeServerStream">AnonymousPipeServerStream</seealso>
	/// </summary>
	public static partial class AnonymousPipeServerStreamable
	{
		/// <summary>
