...
namespace PRI.ProductivityExtensions.ControlEventHandlerExtensions
{

	/// <summary>
	/// Class that contains extension methods that extend <seealso cref="System.Windows.Forms.ControlEventHandler">ControlEventHandler</seealso>
	/// </summary>
	public static partial class ControlEventHandlerable
	{
		/// <summary>
