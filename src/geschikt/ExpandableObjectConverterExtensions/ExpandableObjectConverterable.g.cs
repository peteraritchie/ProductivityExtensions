...
namespace PRI.ProductivityExtensions.ExpandableObjectConverterExtensions
{

	/// <summary>
	/// Class that contains extension methods that extend <seealso cref="System.ComponentModel.ExpandableObjectConverter">ExpandableObjectConverter</seealso>
	/// </summary>
	public static partial class ExpandableObjectConverterable
	{
		/// <summary>
