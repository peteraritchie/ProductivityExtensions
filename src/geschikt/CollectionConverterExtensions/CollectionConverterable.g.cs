...
namespace PRI.ProductivityExtensions.CollectionConverterExtensions
{

	/// <summary>
	/// Class that contains extension methods that extend <seealso cref="System.ComponentModel.CollectionConverter">CollectionConverter</seealso>
	/// </summary>
	public static partial class CollectionConverterable
	{
		/// <summary>
