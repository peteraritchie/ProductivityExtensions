...
namespace PRI.ProductivityExtensions.NamedPipeClientStreamExtensions
{

	/// <summary>
	/// Class that contains extension methods that extend <seealso cref="System.IO.Pipes.NamedPipeClientStream">NamedPipeClientStream</seealso>
	/// </summary>
	public static partial class NamedPipeClientStreamable
	{
		/// <summary>
